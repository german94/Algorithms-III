...
void reacomodar(int vertices, int aristas, int particiones, float **pesos);
...
reacomodar(vertices, aristas, particiones, pesos);//FUNCION PRINCIPAL
...
{	
	...
	vector<int> a;
	for(int i = 0; i < vertices ; i++){a.push_back(i+1);}
